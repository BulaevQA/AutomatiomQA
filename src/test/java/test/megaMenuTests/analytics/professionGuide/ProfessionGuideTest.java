package test.megaMenuTests.analytics.professionGuide;
...
public class ProfessionGuideTest extends BrowserConfig {
    ...
    public void analyticsData() {
        ...
        openLink.openLink("Справочник востребованных профессий");
        infoBlockHealth.errorInfoBlock();
        professionGuidePage.checkPageTitle();
    }
}
